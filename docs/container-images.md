...
| [matrix-nether-voicebridge](configuring-playbook-bridge-nether-voicebridge.md) | [dark/nether-voicebridge](https://nether.codes/dark/nether-voicebridge) | ❌ | Bridge Discord voice channels to Matrix [Element Call](https://element.io/element-call) rooms |
